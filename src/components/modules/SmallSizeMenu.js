...
export default function SmallSizeMenu() {
  return (
    <div className="fixed lg:hidden bottom-2  z-50 left-1/2 -translate-x-1/2  w-[95%] bg-white h-14 xs:h-16 rounded-3xl shadow-purple-400 shadow-2xl">
